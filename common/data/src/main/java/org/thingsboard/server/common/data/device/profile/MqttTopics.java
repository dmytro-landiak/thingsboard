...
public class MqttTopics {
    ...
    private static final String PROTO = "/p";
    ...
    private static final String DEVICE_ATTRIBUTES_RESPONSE_SHORT = ATTRIBUTES_RESPONSE_SHORT + "/";
    private static final String DEVICE_ATTRIBUTES_REQUEST_SHORT = ATTRIBUTES_REQUEST_SHORT + "/";
    ...
    public static final String DEVICE_FIRMWARE_REQUEST_TOPIC_PATTERN = BASE_DEVICE_API_TOPIC_V2 + FIRMWARE + REQUEST_SHORT + "/" + REQUEST_ID_PATTERN + CHUNK + CHUNK_PATTERN;
    public static final String DEVICE_FIRMWARE_RESPONSES_TOPIC = BASE_DEVICE_API_TOPIC_V2 + FIRMWARE + RESPONSE_SHORT + "/" + SUB_TOPIC + CHUNK + SUB_TOPIC;
    public static final String DEVICE_FIRMWARE_ERROR_TOPIC = BASE_DEVICE_API_TOPIC_V2 + FIRMWARE + ERROR;

    public static final String DEVICE_SOFTWARE_FIRMWARE_RESPONSES_TOPIC_FORMAT = BASE_DEVICE_API_TOPIC_V2 + "/%s" + RESPONSE_SHORT + "/%s" + CHUNK + "%d";

    public static final String DEVICE_SOFTWARE_REQUEST_TOPIC_PATTERN = BASE_DEVICE_API_TOPIC_V2 + SOFTWARE + REQUEST_SHORT + "/" + REQUEST_ID_PATTERN + CHUNK + CHUNK_PATTERN;
    public static final String DEVICE_SOFTWARE_RESPONSES_TOPIC = BASE_DEVICE_API_TOPIC_V2 + SOFTWARE + RESPONSE_SHORT + "/" + SUB_TOPIC + CHUNK + SUB_TOPIC;
    ...
    public static final String DEVICE_ATTRIBUTES_RESPONSE_SHORT_TOPIC_PREFIX = BASE_DEVICE_API_TOPIC_V2 + DEVICE_ATTRIBUTES_RESPONSE_SHORT;
    ...
    public static final String DEVICE_ATTRIBUTES_REQUEST_SHORT_TOPIC_PREFIX = BASE_DEVICE_API_TOPIC_V2 + DEVICE_ATTRIBUTES_REQUEST_SHORT;
    public static final String DEVICE_ATTRIBUTES_SHORT_TOPIC = BASE_DEVICE_API_TOPIC_V2 + ATTRIBUTES_SHORT;
    public static final String DEVICE_ATTRIBUTES_SHORT_JSON_TOPIC = BASE_DEVICE_API_TOPIC_V2 + ATTRIBUTES_SHORT + JSON;
    public static final String DEVICE_ATTRIBUTES_SHORT_PROTO_TOPIC = BASE_DEVICE_API_TOPIC_V2 + ATTRIBUTES_SHORT + PROTO;
    public static final String DEVICE_TELEMETRY_SHORT_TOPIC = BASE_DEVICE_API_TOPIC_V2 + TELEMETRY_SHORT;
    public static final String DEVICE_TELEMETRY_SHORT_JSON_TOPIC = BASE_DEVICE_API_TOPIC_V2 + TELEMETRY_SHORT + JSON;
    public static final String DEVICE_TELEMETRY_SHORT_PROTO_TOPIC = BASE_DEVICE_API_TOPIC_V2 + TELEMETRY_SHORT + PROTO;
